...
def createAddWindow():
    ...
    phone_label.grid(column = 0, row = 1, sticky = 'е')
...
def createChangeWindow(contact: list):
    ...
    change_window.title('изменить контак')
    ...
    сomment_label = tk.label(change_window, text = 'Комментарий')
    name_label.grid(column = 0, row = 0, sticky = 'e')
    phone_label.grid(column = 0, row = 1, sticky = 'e')
    сomment_label.grid(column = 0, row = 2, sticky = 'e')
